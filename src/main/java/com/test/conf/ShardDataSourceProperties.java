...
public class ShardDataSourceProperties {
	...
	public ShardDataSourceProperties() {}
	
	public ShardDataSourceProperties(String driverClassName, String url, String username, String password, String url0,
			String username0, String password0, String url1, String username1, String password1, String filters,
			int maxActive, int initialSize, int maxWait, int minIdle, int timeBetweenEvictionRunsMillis,
			...
			boolean removeAbandoned, int removeAbandonedTimeout, boolean logAbandoned,
